...
| ------ | ---------------------------------------------------------------------------------- | ------------ | -------- | ------------- | ----------------- | ---------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| BE-001 | Pick backend platform and hosting path                                             | architecture | P0       | investigating | code-puppy-7937d3 | 2026-06-17 | —              | Local SQLite content DB + ingestion workspace now exists in `packages/content-db`; still need hosted API/realtime/auth path decision.                                                                                          |
...
| BE-003 | Choose auth provider and account model                                             | auth         | P1       | open          | unassigned        | 2026-06-17 | BE-001         | Evaluate Supabase Auth vs Clerk and document how player/DM identities map into party permissions.                                                                                                                              |
