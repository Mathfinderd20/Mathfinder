...
- [~] Editable core build fields in UI started (name, base abilities, carried weight, weapons, equipment/armor rows); skill ranks/race/class/compendium gear editing still pending
