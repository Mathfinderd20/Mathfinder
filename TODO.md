...
- [~] Spellcasting scaffold: caster stats + save DCs + spells/day + bonus slots + prepared/known split + selection state + count/class/level validation + slot expenditure tracking + web runtime controls started; full content DB and extra-slot sources pending
