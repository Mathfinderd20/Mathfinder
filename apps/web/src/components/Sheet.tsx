              ...
              <div key={i}>
                ...
                {c.castingType === "prepared" ? (
                  <>
                    ...
                    <div className="skill"><span className="skill-name">Prepared</span><span className="skill-value">{Object.entries(c.selectedPreparedSpells).map(([lvl, names]) => `${lvl}:${(names ?? []).join(",")}`).join(" | ") || "—"}</span></div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="skill"><span className="skill-name">Known Picks</span><span className="skill-value">{Object.entries(c.selectedKnownSpells).map(([lvl, names]) => `${lvl}:${(names ?? []).join(",")}`).join(" | ") || "—"}</span></div>
                  </>
                )}
              </div>
            ))}
